...
const RegisterPatient = () => {
  ...
  const [activeLink, setActiveLink] = useState('Register Patient');
  ...
  const links = linksMockdata.map((link) => (
    <a
      ...
      href="/"
      onClick={(event) => {
        if(link === "Register Doctor") {
            window.location.href='/admin/register-doctor';
        }        
    ...
    return (
      <div className='container-d' >
        ...
        <div className='input-block'>
          ...
          <TextInput label="Blood group" placeholder="A" className="paperi" required />
          <TextInput label="Emergency contact number" placeholder="87021235687" className="paperi" required />
          <TextInput label="Email" placeholder="john.smith@gmail.com" className="paperi" />
          <TextInput label="Address" placeholder="Baker street 45" className="paperi" required />
          <TextInput label="Marital status" placeholder="Married" className="paperi" required />
          <TextInput label="Registration date" placeholder="DD/MM/YYYY" className="paperi" required />
