              ...
              <HoverCard.Dropdown sx={{ overflow: "hidden" }}>
                ...
                {timeslots.forEach((value, key) => (
                    <div className={classes.dates}>
                        ...
                        <Button onClick={() => [setOpened((o) => !o ), setTimeslot(key) ] }>Make appointment</Button>
                    </div>
                    ))}
              </HoverCard.Dropdown>
            </HoverCard>
            ...
            >
             <div>
                ...
                <div style={{marginTop:10}}>
                    <Button onClick={(e) => [setOpened(false), handleClick(e), setData(item) ]}>Send</Button>
                </div>
                </div>
            </Dialog>
        </Card>
